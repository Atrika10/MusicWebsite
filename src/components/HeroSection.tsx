...
export default function HeroSection() {
  return (
    <>
      ...
      <Spotlight
        className="-top-[6rem] left-0 
        md:left-32 md:-top-20 lg:-top-28"
        fill="cyan"
      />
        <div className="p-4 relative z-10 w-full text-center flex flex-col items-center justify-center mt-5">
          <div
          ...
          <div>
            <Link href="/courses">
              <button className="mt-8 inline-flex h-12 animate-shimmer items-center justify-center rounded-xl border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                Explore Courses
              </button>
            </Link>
          </div>
